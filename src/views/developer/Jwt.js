  ...
  return (
    <>
      <div className="content">
        ...
        <h1 className="title mt-5 text-center">JSON Web Token &#128125;</h1>
        <CardBody>
          <Row>
            <Col sx="6">
              <h2 className="mt-5">What is a JWT?</h2>
              <div className="text-justify">
                <p>
                  JWT is an open, industry-standard (RFC 7519) <mark>for representing claims securely</mark> between two parties.
                </p>
                <br />
                <p>
          ...
          <Row>
            <Col sx="4">
              <h2 className="mt-5">Registered Claim Names</h2>
              <div className="text-justify">
                <p>
            ...
            <Col sx="4">
              <h2 className="mt-5">Expiration Time Claim (exp)</h2>
              <div className="text-justify">
                <p>
                  The “exp” (expiration time) claim identifies the expiration time on or after which the JWT MUST NOT be accepted for processing.
                  <br />
                  <br />
                  The processing of the “exp” claim requires that the current date/time MUST be before the expiration date/time listed in the “exp” claim. Implementers MAY provide for some small leeway, usually no more than a few minutes, to account for clock skew.
                  <br />
                  <br />
            ...
            <Col sx="4">
              <h2 className="mt-5">Not Before Time Claim (nbf)</h2>
              <div className="text-justify">
                <p>
                  The “nbf” (not before) claim identifies the time before which the JWT MUST NOT be accepted for processing.
                  <br />
                  <br />
                  The processing of the “nbf” claim requires that the current date/time MUST be after or equal to the not-before date/time listed in the “nbf” claim. Implementers MAY provide for some small leeway, usually no more than a few minutes, to account for clock skew.
                  <br />
                  <br />
                  Its value MUST be a number containing a NumericDate value. Use of this claim is OPTIONAL.
                </p>
          ...
          <Row>
            <Col sx="6">
              <h2 className="mt-5">Issuer Claim (iss)</h2>
              <div className="text-justify">
                <p>
            ...
            <Col sx="6">
              <h2 className="mt-5">Audience Claim (aud)</h2>
              <div className="text-justify">
                <p>
